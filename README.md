...
*This repository contains the source for the [`haskell`](https://hub.docker.com/r/library/haskell/) Official Repository on DockerHub.*
...
As of `7.10.3`, the `stack` tool is also included.
